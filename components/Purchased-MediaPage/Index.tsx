                          ...
                          <div className="pm-page-filters-container">
                            ...
                            <div className="pm-page-select-filters-wrapper">
                                    ...
                                    <div className="custom-select-options-dropdown-container">
                                      <div className="custom-select-options-search" data-custom-select-options-search>
                                        <div className="label-input">
                                          ...
                                          <div className="input-placeholder-icon">
                                            <svg className="svg-icon" xmlns="http://www.w3.org/2000/svg" width="24"
                              ...
                              <div className="pm-page-select">
                                ...
                                <div className="custom-select-element" data-custom-select-element data-custom-select-value>
                                  <div className="custom-select-label-wrapper" data-custom-select-triger onClick={() => setAllcreator((prev) => !prev)}>
                                    <div className="custom-select-icon-txt">
                                      <span className="custom-select-label-txt">
                                        All Creators
                                      </span>
                        ...
                        <div className="hero-type-card-wrapper ">
                          <div className="hero-type-card-container card">
                            ...
                            <div className="hero-type-card--bg-img">
                              <img src="/images/purchased-media-hero-bg-image.jpg"
                            ...
                            <div className="hero-type-card--content-container">
                              ...
                              <div className="hero-type-card--desc">
                                <p>
                                  Step into the arena where precision, teamwork, and reflex decide the next champion.
                                </p>
                              </div>
                          ...
                          <div className="multi-tabs-layout-container">
                            <div className="pm-multi-tabs-buttons-wrapper">
                              <div className="multi-tabs-action-buttons">
                                <button className="multi-tab-switch-btn" data-multi-tabs-switch-btndata__active>
                                  <span>Favorites</span>
                                </button>
                                <button className="multi-tab-switch-btn" data-multi-tabs-switch-btn>
                                ...
                                <div className="pm-page-content-cards-wrapper">
                                  <div className="pm-page-content-card">
                                    ...
                                    <div className="pm-page-card-media-container">
                                      ...
                                      <div className="pm-page-card--img">
                                        <img src="/images/purchased-media/purchased-media-post-img-4.jpg"
                                          alt="#"/>
                                      </div>
                                    ...
                                    <div className="pm-page-card-body">
                                      <h2>
                                        Shazam Radiant Ranked – Season 16
                                      </h2>
                                    </div>
                                  ...
                                  <div className="pm-page-content-card">
                                    ...
                                    <div className="pm-page-card-media-container">
                                      ...
                                      <div className="pm-page-card--img">
                                        <img src="/images/purchased-media/purchased-media-post-img-3.jpg"
                                          alt="#"/>
                                      </div>
                                  ...
                                  <div className="pm-page-content-card">
                                    ...
                                    <div className="pm-page-card-media-container">
                                      ...
                                      <div className="pm-page-card--img">
                                        <img src="/images/purchased-media/purchased-media-post-img-2.jpg"
                                          alt="#"/>
                                      </div>
                                  ...
                                  <div className="pm-page-content-card">
                                    ...
                                    <div className="pm-page-card-media-container">
                                      ...
                                      <div className="pm-page-card--img">
                                        <img src="/images/purchased-media/purchased-media-post-img-1.jpg"
                                          alt="#"/>
                                      </div>
