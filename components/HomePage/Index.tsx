      ...
      <div className="discovery-page-container">
        <div className="discovery-page-content-container">
          <div className="discover-page-filters-container">
            <div className="content-filters-main-wrapper" data-content-advanced-filters-container>
                ...
                <div className="content-basic-filters-wrapper">
                  <div className="content-basic-filters-container">
                            ...
                            <div className="custom-select-icon-txt">
                              <svg xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24"
                                ...
                                <path
                                  ...
                                  stroke="none" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M13.3901 8.53L18.2401 9.76" stroke="none" stroke-width="1.5"
                                  stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M12.4102 12.4L15.3102 13.14" stroke="none" stroke-width="1.5"
                                  stroke-linecap="round" stroke-linejoin="round" />
                              </svg>
                    ...
                    <div className="show-advance-filter-btn">
                      <button className="premium-btn" data-content-advanced-filters-toggle-button>
                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24" fill="none">
                          <path
                          ...
                          <defs>
                            <linearGradient id="paint0_linear_1_1745" x1="6.17502" y1="5.25" x2="24.1481" y2="9.632"
              ...
              <div className="content-advanced-filters-wrapper" data-content-advanced-filters>
          ...
          <div className="discovery-page-content-wrapper">
            <div className="discovery-page-cards-layouts">
              ...
              <div className="user-profile-card-wrapper" data-creator-profile-card>
                <div className="user-profile-card-container">
                  <div className="user-profile-card__img">
                    <img src="/images/profile-avatars/profile-avatar-11.png" alt="Discover Profile Avatar" />
                  </div>
                      ...
                      <div className="user-profile-card__wishlist-btn">
                        <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20" fill="none">
                          ...
                          <path
                            d="M14.7666 1.66687H6.73327C4.95827 1.66687 3.5166 3.11687 3.5166 4.88354V16.6252C3.5166 18.1252 4.5916 18.7585 5.90827 18.0335L9.97494 15.7752C10.4083 15.5335 11.1083 15.5335 11.5333 15.7752L15.5999 18.0335C16.9166 18.7669 17.9916 18.1335 17.9916 16.6252V4.88354C17.9833 3.11687 16.5416 1.66687 14.7666 1.66687Z"
                            stroke="none" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                          <path d="M8.4585 7.5415C9.94183 8.08317 11.5585 8.08317 13.0418 7.5415" stroke="none"
                            stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                      </div>
                    </div>
              ...
              <div className="user-profile-card-wrapper" data-creator-profile-card>
                <div className="user-profile-card-container">
                  <div className="user-profile-card__img">
                    <img src="/images/profile-avatars/profile-avatar-6.jpg" alt="Discover Profile Avatar" />
                  </div>
              ...
              <div className="user-profile-card-wrapper" data-creator-profile-card>
                <div className="user-profile-card-container">
                  <div className="user-profile-card__img">
                    <img src="/images/profile-avatars/profile-avatar-5.jpg" alt="Discover Profile Avatar" />
                  </div>
              ...
              <div className="user-profile-card-wrapper" data-creator-profile-card>
                <div className="user-profile-card-container">
                  <div className="user-profile-card__img">
                    <img src="/images/profile-avatars/profile-avatar-3.jpg" alt="Discover Profile Avatar" />
                  </div>
              ...
              <div className="user-profile-card-wrapper" data-creator-profile-card>
                <div className="user-profile-card-container">
                  <div className="user-profile-card__img">
                    <img src="/images/profile-avatars/profile-avatar-12.jpg" alt="Discover Profile Avatar" />
                  </div>
              ...
              <div className="user-profile-card-wrapper" data-creator-profile-card>
                <div className="user-profile-card-container">
                  <div className="user-profile-card__img">
                    <img src="/images/profile-avatars/profile-avatar-14.jpg" alt="Discover Profile Avatar" />
                  </div>
              ...
              <div className="user-profile-card-wrapper" data-creator-profile-card>
                <div className="user-profile-card-container">
                  <div className="user-profile-card__img">
                    <img src="/images/profile-avatars/profile-avatar-13.jpg" alt="Discover Profile Avatar" />
                  </div>
              ...
              <div className="user-profile-card-wrapper" data-creator-profile-card>
                <div className="user-profile-card-container">
                  <div className="user-profile-card__img">
                    <img src="/images/profile-avatars/profile-avatar-10.jpg" alt="Discover Profile Avatar" />
                  </div>
