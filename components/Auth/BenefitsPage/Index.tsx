      ...
      <div className="moneyboy-feed-page-container cont_wrap">
        <div className="main_cont">
          ...
          <div className="moneyboy-feed-page-cate-buttons card" id="posts-tabs-btn-card">
            <button className={`page-content-type-button active-down-effect ${activeTab === "fan" ? "active" : ""}`} onClick={() => setActiveTab("fan")}>Fan Signup</button>
            <button className={`page-content-type-button active-down-effect ${activeTab === "creator" ? "active" : ""}`} onClick={() => setActiveTab("creator")}>Creator Signup</button>
          </div>
            ...
            {activeTab === "fan" && (
              <>
                ...
                <ul className="benefitspoint">
                  <li>Discover free and exclusive content from verified creators</li>
                  <li>Subscribe monthly or yearly to your favorite MoneyBoys</li>
                  <li>Unlock paid posts and videos instantly (PPV – Pay Per View)</li>
                ...
                <button className="premium-btn"><span>Fan Signup</span></button>
              </>
            )}
            {activeTab === "creator" && (
              <>
                ...
                <ul className="benefitspoint">
                  ...
                  <li>Earn from subscriptions, tips, and Pay-Per-View content</li>
                  <li>Receive custom content requests directly from fans</li>
                  <li>Keep 80% of everything you earn — no hidden fees</li>
                  <li>Access your wallet and analytics dashboard in real time</li>
                  <li>Chat privately and build loyal fan relationships</li>
                  <li>Promote your free feed publicly and gain more followers</li>
                  <li>Sell exclusive content and bundles in your personal store</li>
                  <li>Collaborate with other verified creators</li>
                  <li>Full ownership of your content and total payout transparency</li>
                </ul>
                <button className="premium-btn"><span>Creator Signup</span></button>
              </>
            )}
          </div>
