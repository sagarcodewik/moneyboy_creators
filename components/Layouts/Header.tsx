        ...
        <div className="header-container">
          ...
          <div className="header-search-nav-profile-container">
            ...
            <div className="header-profile-avatar">
              <button data-floating-menu-triger onClick={() => setIsOpen((prev) => !prev)}>
                <div className="profile-avatar">
                  <Image src="/images/profile-avatars/profile-avatar-1.png"
                    alt="User Images"
                    width={40}
                    height={40}
                  />
          ...
          <div className="menu-content">
                    ...
                    <div className="icon">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 25" fill="none">
                        <path
                          ...
                          stroke="none" stroke-width="none" stroke-linecap="round" stroke-linejoin="round" />
                        <path
                        ...
                        <path
                          ...
                          stroke="none" stroke-width="none" stroke-linecap="round" stroke-linejoin="round" />
                        <path d="M7 12.5H14" stroke="none" stroke-width="none" stroke-linecap="round"
                      ...
                      <div className="stats-value">
                        ...
                        <a href="#" className="load-wallet-btn">
                          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"
                            fill="none">
                            <path d="M5.3335 8H10.6668" stroke="url(#paint0_linear_1510_49)" stroke-linecap="round"
                              stroke-linejoin="round" />
                            <path d="M8 10.6667V5.33333" stroke="url(#paint1_linear_1510_49)" stroke-linecap="round"
                              stroke-linejoin="round" />
                            <path
                              ...
                              stroke="url(#paint2_linear_1510_49)" stroke-linecap="round" stroke-linejoin="round" />
                            <defs>
                              <linearGradient id="paint0_linear_1510_49" x1="5.64956" y1="8" x2="8.44518" y2="11.6352"
                                gradientUnits="userSpaceOnUse">
                                <stop stop-color="#FECE26" />
                                <stop offset="1" stop-color="#E5741F" />
                              </linearGradient>
                              <linearGradient id="paint1_linear_1510_49" x1="8.05926" y1="5.33333" x2="9.4668"
                                y2="5.39767" gradientUnits="userSpaceOnUse">
                                <stop stop-color="#FECE26" />
                                <stop offset="1" stop-color="#E5741F" />
                              </linearGradient>
                              <linearGradient id="paint2_linear_1510_49" x1="2.12364" y1="1.33333" x2="19.8748"
                                y2="5.66123" gradientUnits="userSpaceOnUse">
                                <stop stop-color="#FECE26" />
                                <stop offset="1" stop-color="#E5741F" />
                              </linearGradient>
                            </defs>
            ...
            <div className="menu-links-container">
                  ...
                  <a href="#" className="menu-link edit-profile-link">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 25" fill="none">
                      ...
                      <path
                        ...
                        stroke="none" stroke-width="none" stroke-miterlimit="10" stroke-linecap="round"
                        stroke-linejoin="round" />
                      <path d="M18.7002 16.3929C19.0002 17.4729 19.8402 18.3128 20.9202 18.6128" stroke="none"
                        stroke-width="none" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                  ...
                  <a href="#" className="menu-link blacklist-link">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none">
                      ...
                      <path
                        ...
                        stroke-linejoin="round" />
                      <path d="M15.5 15.6429L20.5 20.1429" stroke="none" stroke-width="1.5" stroke-miterlimit="10"
                  ...
                  <a href="#" className="menu-link block-countries-link">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none">
                      <path
                        ...
                        stroke="none" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                      <path d="M18.5 19.1428L5.5 4.64282" stroke="none" stroke-width="1.5" stroke-linecap="round"
                        stroke-linejoin="round" />
                    </svg>
                  ...
                  <a href="#" className="menu-link banking-to-earn-link">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none">
                      ...
                      <path
                        ...
                        stroke="none" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round"
                        stroke-linejoin="round" />
                      <path d="M4 18.1429V11.1429" stroke="none" stroke-width="1.5" stroke-miterlimit="10"
                        stroke-linecap="round" stroke-linejoin="round" />
                      <path d="M8 18.1429V11.1429" stroke="none" stroke-width="1.5" stroke-miterlimit="10"
                        stroke-linecap="round" stroke-linejoin="round" />
                      <path d="M12 18.1429V11.1429" stroke="none" stroke-width="1.5" stroke-miterlimit="10"
                        stroke-linecap="round" stroke-linejoin="round" />
                      <path d="M16 18.1429V11.1429" stroke="none" stroke-width="1.5" stroke-miterlimit="10"
                        stroke-linecap="round" stroke-linejoin="round" />
                      <path d="M20 18.1429V11.1429" stroke="none" stroke-width="1.5" stroke-miterlimit="10"
                        stroke-linecap="round" stroke-linejoin="round" />
                      <path d="M1 22.1429H23" stroke="none" stroke-width="1.5" stroke-miterlimit="10"
                        stroke-linecap="round" stroke-linejoin="round" />
                      <path
                  ...
                  <a href="#" className="menu-link posts-link">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none">
                      <path
                        ...
                        stroke="none" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                      <path d="M22 10.4286H18C15 10.4286 14 9.42856 14 6.42856V2.42856L22 10.4286Z" stroke="none"
                        stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                      <path d="M7 13.4286H13" stroke="none" stroke-width="1.5" stroke-linecap="round"
                        stroke-linejoin="round" />
                      <path d="M7 17.4286H11" stroke="none" stroke-width="1.5" stroke-linecap="round"
                        stroke-linejoin="round" />
                    </svg>
                    <span>Posts</span>
                  </a>
                  ...
                  <a href="#" className="menu-link wishlist-link">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none">
                      ...
                      <path
                        d="M16.8198 2.42859H7.17982C5.04982 2.42859 3.31982 4.16859 3.31982 6.28859V20.3786C3.31982 22.1786 4.60982 22.9386 6.18982 22.0686L11.0698 19.3586C11.5898 19.0686 12.4298 19.0686 12.9398 19.3586L17.8198 22.0686C19.3998 22.9486 20.6898 22.1886 20.6898 20.3786V6.28859C20.6798 4.16859 18.9498 2.42859 16.8198 2.42859Z"
                        stroke="none" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                      <path d="M9.25 9.47864C11.03 10.1286 12.97 10.1286 14.75 9.47864" stroke="none" stroke-width="1.5"
                        stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                    <span>Wishlist</span>
                  </a>
              ...
              <div className="links-block">
                ...
                <div className="menu-links-wrapper">
                  <a href="#" className="menu-link wallet-transactions-link">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none">
                      <path
                      ...
                      <path
                        ...
                        stroke="none" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                      <path d="M7 12.7143H14" stroke="none" stroke-width="1.5" stroke-linecap="round"
                        stroke-linejoin="round" />
                    </svg>
                  ...
                  <a href="#" className="menu-link order-history-link">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none">
                      ...
                      <path
                        ...
                        stroke="none" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round"
                        stroke-linejoin="round" />
                      <path d="M15.4955 12.7143H15.5045" stroke="none" stroke-width="2" stroke-linecap="round"
                        stroke-linejoin="round" />
                      <path d="M8.49451 12.7143H8.50349" stroke="none" stroke-width="2" stroke-linecap="round"
                        stroke-linejoin="round" />
                    </svg>
                  ...
                  <a href="#" className="menu-link payment-history-link">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none">
                      ...
                      <path
                        ...
                        stroke="none" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round"
                        stroke-linejoin="round" />
                      <path d="M6 9.71429H12" stroke="none" stroke-width="1.5" stroke-linecap="round"
                        stroke-linejoin="round" />
                      <path d="M6.75 13.7143H11.25" stroke="none" stroke-width="1.5" stroke-linecap="round"
                        stroke-linejoin="round" />
                    </svg>
                ...
                <div className="menu-links-wrapper">
                  <a href="#" className="menu-link payout-requests-link">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                      <path d="M22 12C22 17.52 17.52 22 12 22C6.48 22 2 17.52 2 12C2 6.48 6.48 2 12 2" stroke="none"
                        stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                      <path
                        ...
                        stroke="none" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                      <path d="M12 7.5V16.5" stroke="none" stroke-width="1.5" stroke-linecap="round"
                        stroke-linejoin="round" />

                      <path d="M22 6V2H18" stroke="none" stroke-width="1.5" stroke-linecap="round"
                        stroke-linejoin="round" />
                      <path d="M17 7L22 2" stroke="none" stroke-width="1.5" stroke-linecap="round"
                        stroke-linejoin="round" />
                    </svg>
                    <span>Payout Requests</span>
                  </a>
                  <a href="#" className="menu-link premium-btn">
                    <svg className="self-colored" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                      ...
                      <path
                        ...
                        stroke="url(#paint0_linear_1469_2244)" stroke-width="1.5" stroke-miterlimit="10"
                        stroke-linecap="round" stroke-linejoin="round" />
                      <path
                        ...
                        stroke="url(#paint1_linear_1469_2244)" stroke-width="1.5" stroke-linecap="round"
                        stroke-linejoin="round" />
                      <path
                        ...
                        stroke="url(#paint2_linear_1469_2244)" stroke-width="1.5" stroke-linecap="round"
                        stroke-linejoin="round" />
                      <defs>
                        <linearGradient id="paint0_linear_1469_2244" x1="4.0667" y1="2" x2="28.2887" y2="7.31567"
                          gradientUnits="userSpaceOnUse">
                          <stop stop-color="#FECE26" />
                          <stop offset="1" stop-color="#E5741F" />
                        </linearGradient>
                        <linearGradient id="paint1_linear_1469_2244" x1="10.2712" y1="5.04999" x2="15.4635" y2="6.31597"
                          gradientUnits="userSpaceOnUse">
                          <stop stop-color="#FECE26" />
                          <stop offset="1" stop-color="#E5741F" />
                        </linearGradient>
                        <linearGradient id="paint2_linear_1469_2244" x1="8.6966" y1="11.21" x2="17.899" y2="14.7595"
                          gradientUnits="userSpaceOnUse">
                          <stop stop-color="#FECE26" />
                          <stop offset="1" stop-color="#E5741F" />
                        </linearGradient>
                    ...
                    <svg className="arrow-icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                      viewBox="0 0 24 24" fill="none">
                      <path d="M5 12H19" stroke="none" stroke-width="2" stroke-linecap="round"
                        stroke-linejoin="round" />
                      <path d="M12 5L19 12L12 19" stroke="none" stroke-width="2" stroke-linecap="round"
                        stroke-linejoin="round" />
                    </svg>
                  </a>
                  <a href="#" className="menu-link sign-out-link">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                      <path
                        ...
                        stroke="none" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                      <path d="M8.99988 12H20.3799" stroke="none" stroke-width="1.5" stroke-linecap="round"
                        stroke-linejoin="round" />
                      <path d="M18.15 8.65002L21.5 12L18.15 15.35" stroke="none" stroke-width="1.5"
                        stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                    <span>Sign Out</span>
                  </a>
