                      ...
                      <div className="profile-card">
                                ...
                                <a href="#" className="save-btn">
                                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25"
                                    ...
                                    <path
                                      d="M16.8203 2.5H7.18031C5.05031 2.5 3.32031 4.24 3.32031 6.36V20.45C3.32031 22.25 4.61031 23.01 6.19031 22.14L11.0703 19.43C11.5903 19.14 12.4303 19.14 12.9403 19.43L17.8203 22.14C19.4003 23.02 20.6903 22.26 20.6903 20.45V6.36C20.6803 4.24 18.9503 2.5 16.8203 2.5Z"
                                      stroke="none" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M9.25 9.54999C11.03 10.2 12.97 10.2 14.75 9.54999" stroke="none"
                                ...
                                <a href="#" className="tip-btn">
                                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25"
                                    ...
                                    <path
                                      ...
                                      stroke="none" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M10 13.35V14.09" stroke="none" stroke-width="1.5" stroke-linecap="round"
                                      stroke-linejoin="round" />
                                    <path d="M10 6.91V7.69" stroke="none" stroke-width="1.5" stroke-linecap="round"
                                      stroke-linejoin="round" />
                                  </svg>
                                </a>
                              </li>
                                ...
                                <a href="#" className="share-btn">
                                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25"
                                    ...
                                    <path
                                      ...
                                      stroke="none" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M12 15.5V4.12" stroke="none" stroke-width="1.5" stroke-linecap="round"
                                      stroke-linejoin="round" />
                                    <path d="M15.3504 6.35L12.0004 3L8.65039 6.35" stroke="none" stroke-width="1.5"
                                ...
                                <a href="#" className="message-btn">
                                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25"
                                    ...
                                    <path
                                      ...
                                      stroke="none" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M15.9965 11.5H16.0054" stroke="none" stroke-width="2"
                                      stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M11.9945 11.5H12.0035" stroke="none" stroke-width="2"
                                      stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M7.99451 11.5H8.00349" stroke="none" stroke-width="2"
                                      stroke-linecap="round" stroke-linejoin="round" />
                                  </svg>
                                </a>
                              </li>
                        ...
                        <div className="profile-card__geo-details">
                          ...
                          <div className="profile-card__geo-detail">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                              fill="none">
                              <path d="M8 2V5" stroke="none" stroke-width="1.5" stroke-miterlimit="10"
                                stroke-linecap="round" stroke-linejoin="round" />
                              <path d="M16 2V5" stroke="none" stroke-width="1.5" stroke-miterlimit="10"
                                stroke-linecap="round" stroke-linejoin="round" />
                              <path
                                d="M21 8.5V17C21 20 19.5 22 16 22H8C4.5 22 3 20 3 17V8.5C3 5.5 4.5 3.5 8 3.5H16C19.5 3.5 21 5.5 21 8.5Z"
                                stroke="none" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round"
                                stroke-linejoin="round" />
                              <path d="M8 11H16" stroke="none" stroke-width="1.5" stroke-miterlimit="10"
                                stroke-linecap="round" stroke-linejoin="round" />
                              <path d="M8 16H12" stroke="none" stroke-width="1.5" stroke-miterlimit="10"
                                stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                            ...
                            <div className="profile-card__stats-item posts-stats">
                              ...
                              <div className="profile-card__stats-label">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25"
                                  ...
                                  <path d="M22 10.4286H18C15 10.4286 14 9.42856 14 6.42856V2.42856L22 10.4286Z"
                                    stroke="none" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                                  </path>
                      ...
                      <div className="multi-tab-section" data-multiple-tabs-section>
                        <div className="multi-tabs-layout-container">
                          <div className="multi-tabs-action-buttons">
                            <button className="multi-tab-switch-btn posts-btn" data-multi-tabs-switch-btndata__active>
                              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25"
                                fill="none">
                                <path
                                  d="M22 10.5V15.5C22 20.5 20 22.5 15 22.5H9C4 22.5 2 20.5 2 15.5V9.5C2 4.5 4 2.5 9 2.5H14"
                                  stroke="none" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M22 10.5H18C15 10.5 14 9.5 14 6.5V2.5L22 10.5Z" stroke="none"
                                  stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M7 13.5H13" stroke="none" stroke-width="1.5" stroke-linecap="round"
                                  stroke-linejoin="round" />
                                <path d="M7 17.5H11" stroke="none" stroke-width="1.5" stroke-linecap="round"
                                  stroke-linejoin="round" />
                              </svg>
                              <span>Posts</span>
                            </button>
                            <button className="multi-tab-switch-btn videos-btn" data-multi-tabs-switch-btn>
                              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25"
                                fill="none">
                                <path
                          ...
                          <div className="multi-tabs-content-container content-creator-profile-tabs-layout-wrapper">
                                ...
                                <div className="search-features-grid-btns">
                                  ...
                                  <div className="creater-content-filters-layouts">
                                    <div className="creator-content-select-filter">
                                      <div className="custom-select-element bg-white p-sm" data-custom-select-element
                                ...
                                <div className="creator-content-cards-wrapper multi-dem-cards-wrapper-layout"
                                  ...
                                  <div className="creator-content-card-container">
                                    <div className="creator-content-card">
                                      <div className="creator-content-card__media">
                                        <div className="creator-card__img">
                                          <img src="/images/post-images/post-img-2.png"
                                            alt="Creator Content Image" />
                                        </div>
                                        <div className="content-locked-label">
                                          <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20"
                                            ...
                                            <path
                                              ...
                                              stroke="none" stroke-width="1.5" stroke-linecap="round"
                                              stroke-linejoin="round" />
                                            <path d="M6.04199 18.3333H15.2087" stroke="none" stroke-width="1.5"
                                              stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M8.54199 11.6667H12.7087" stroke="none" stroke-width="1.5"
                                              stroke-linecap="round" stroke-linejoin="round" />
                                          </svg>
                                  ...
                                  <div className="creator-content-card-container">
                                    <div className="creator-content-card">
                                      <div className="creator-content-card__media">
                                        <div className="creator-card__img">
                                          <img src="/images/profile-banners/profile-banner-8.jpg"
                                            alt="Creator Content Image" />
                                        </div>
                                        <div className="content-locked-label">
                                          <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20"
                                  ...
                                  <div className="creator-content-card-container">
                                    <div className="creator-content-card">
                                      <div className="creator-content-card__media">
                                        <div className="creator-card__img">
                                          <img src="/images/profile-avatars/profile-avatar-9.jpg"
                                            alt="Creator Content Image" />
                                        </div>
                                        <div className="content-locked-label">
                                          <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20"
                            ...
                            <div data-multi-tabs-content-tab data-multi-dem-cards-layout>
                              <div className="creator-content-filter-grid-container">
                                <div className="search-features-grid-btns">
                                  <div className="creator-content-search-input">
                                    <div className="label-input">
