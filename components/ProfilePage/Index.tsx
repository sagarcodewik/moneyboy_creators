                      ...
                      <div className="profile-card">
                                ...
                                <a href="#" className="tip-btn">
                                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25"
                                    ...
                                    <path
                                      ...
                                      stroke="none" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                    <path d="M10 13.35V14.09" stroke="none" strokeWidth="1.5" strokeLinecap="round"
                                      strokeLinejoin="round" />
                                    <path d="M10 6.91V7.69" stroke="none" strokeWidth="1.5" strokeLinecap="round"
                                      strokeLinejoin="round" />
                                  </svg>
                                </a>
                              </li>
                                ...
                                <a href="#" className="share-btn">
                                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25"
                                    ...
                                    <path
                                      ...
                                      stroke="none" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                    <path d="M12 15.5V4.12" stroke="none" strokeWidth="1.5" strokeLinecap="round"
                                      strokeLinejoin="round" />
                                    <path d="M15.3504 6.35L12.0004 3L8.65039 6.35" stroke="none" strokeWidth="1.5"
                                ...
                                <a href="#" className="message-btn">
                                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25"
                                    ...
                                    <path
                                      ...
                                      stroke="none" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                    <path d="M15.9965 11.5H16.0054" stroke="none" strokeWidth="2"
                                      strokeLinecap="round" strokeLinejoin="round" />
                                    <path d="M11.9945 11.5H12.0035" stroke="none" strokeWidth="2"
                                      strokeLinecap="round" strokeLinejoin="round" />
                                    <path d="M7.99451 11.5H8.00349" stroke="none" strokeWidth="2"
                                      strokeLinecap="round" strokeLinejoin="round" />
                                  </svg>
                                </a>
                              </li>
                        ...
                        <div className="profile-card__geo-details">
                          ...
                          <div className="profile-card__geo-detail">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                              fill="none">
                              <path d="M8 2V5" stroke="none" strokeWidth="1.5" strokeMiterlimit="10"
                                strokeLinecap="round" strokeLinejoin="round" />
                              <path d="M16 2V5" stroke="none" strokeWidth="1.5" strokeMiterlimit="10"
                                strokeLinecap="round" strokeLinejoin="round" />
                              <path
                                d="M21 8.5V17C21 20 19.5 22 16 22H8C4.5 22 3 20 3 17V8.5C3 5.5 4.5 3.5 8 3.5H16C19.5 3.5 21 5.5 21 8.5Z"
                                stroke="none" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round"
                                strokeLinejoin="round" />
                              <path d="M8 11H16" stroke="none" strokeWidth="1.5" strokeMiterlimit="10"
                                strokeLinecap="round" strokeLinejoin="round" />
                              <path d="M8 16H12" stroke="none" strokeWidth="1.5" strokeMiterlimit="10"
                                strokeLinecap="round" strokeLinejoin="round" />
                            </svg>
                            ...
                            <div className="profile-card__stats-item posts-stats">
                              ...
                              <div className="profile-card__stats-label">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25"
                                  ...
                                  <path d="M7 13.4286H13" stroke="none" strokeWidth="1.5" strokeLinecap="round"
                                    strokeLinejoin="round"></path>
                                  <path d="M7 17.4286H11" stroke="none" strokeWidth="1.5" strokeLinecap="round"
                                    strokeLinejoin="round"></path>
                                </svg>
                                <span>Posts</span>
                              </div>
                            ...
                            <button className="multi-tab-switch-btn posts-btn" data-multi-tabs-switch-btndata__active>
                              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25"
                                ...
                                <path d="M22 10.5H18C15 10.5 14 9.5 14 6.5V2.5L22 10.5Z" stroke="none"
                                  strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                <path d="M7 13.5H13" stroke="none" strokeWidth="1.5" strokeLinecap="round"
                                  strokeLinejoin="round" />
                                <path d="M7 17.5H11" stroke="none" strokeWidth="1.5" strokeLinecap="round"
                                  strokeLinejoin="round" />
                              </svg>
                              <span>Posts</span>
                            </button>
                                        ...
                                        <div className="content-locked-label">
                                          <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20"
                                            ...
                                            <path
                                              ...
                                              stroke="none" strokeWidth="1.5" strokeLinecap="round"
                                              strokeLinejoin="round" />
                                            <path d="M6.04199 18.3333H15.2087" stroke="none" strokeWidth="1.5"
                                              strokeLinecap="round" strokeLinejoin="round" />
                                            <path d="M8.54199 11.6667H12.7087" stroke="none" strokeWidth="1.5"
                                              strokeLinecap="round" strokeLinejoin="round" />
                                          </svg>
