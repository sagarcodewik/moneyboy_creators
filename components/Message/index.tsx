        ...
        <div className="moneyboy-2x-1x-layout-container">
          <div className="moneyboy-2x-1x-a-layout">
            <div className="msg-page-wrapper card">
              <div className="msg-page-container" msg-page-wrapper>
                <div className="msg-profiles-layout">
                  ...
                  <div className="msg-profiles-wrapper">
                    <div
                      className="msg-profiles-container"
                      msg-chat-contacts-wrapper
                    >
                      <div
                        className={`msg-contact-box ${activeChat === "james" ? "active" : ""}`}
                        msg-chat-contact
                      ...
                      <div
                        className={`msg-contact-box ${activeChat === "jerome" ? "active" : ""}`}
                        msg-chat-contact
                            ...
                            <div className="chat-room-body-container">
                              ...
                              <div className="chat-msg-wrapper outcoming-message">
                                ...
                                <div className="chat-msg-txt-wrapper">
                                  <div className="chat-msg-txt">
                                    <p>
                                      Do androids truly dream of electric
                                      sheeps?
                                    </p>
                                  </div>
                                  <div className="chat-msg-details">
                            ...
                            <div className="chat-room-header-container">
                              ...
                              <div className="chat-room-header-btns">
                                ...
                                <div
                                  ...
                                  data-more-actions-toggle-element
                                >
                                  <button className="rel-user-more-opts-trigger-icon" onClick={() => toggleMenu(2)}>
                                    <svg
                                      xmlns="http://www.w3.org/2000/svg"
                                      width="24"
                                      height="25"
