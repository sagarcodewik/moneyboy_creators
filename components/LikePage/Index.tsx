                ...
                <div className="moneyboy-feed-page-container" data-multiple-tabs-section data-scroll-zero>
                  ...
                  <div className="moneyboy-posts-wrapper moneyboy-diff-content-wrappers" data-multi-tabs-content-tabdata__active>
                              ...
                              <a href="#">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                  ...
                                  <path
                                    ...
                                    stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                  <path d="M10 12.85V13.59" stroke="white" strokeWidth="1.5" strokeLinecap="round"
                                    strokeLinejoin="round" />
                                  <path className="dollar-sign" d="M10 6.40997V7.18997" stroke="white" strokeWidth="1.5"
                          ...
                          <ul>
                            <li>
                              <a href="#">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                  fill="none">
                                  <path d="M5.15002 2V22" stroke="white" strokeWidth="1.5" strokeMiterlimit="10"
                                    strokeLinecap="round" strokeLinejoin="round" />
                                  <path
                    ...
                    <div className="moneyboy-post__container card">
                      ...
                      <div className="moneyboy-post__media">
                        <div className="moneyboy-post__img">
                          <img src="/images/post-images/post-img-5.jpg" alt="MoneyBoy Post Image" />
                        </div>
                        <div className="moneyboy-post__actions">
                          <ul>
                            <li>
                    ...
                    <div className="moneyboy-post__container card">
                      ...
                      <div className="moneyboy-post__media">
                        <div className="moneyboy-post__img">
                          <img src="/images/post-images/post-img-4.jpg" alt="MoneyBoy Post Image" />
                        </div>
                        <div className="moneyboy-post__actions">
                          <ul>
                            <li>
                  ...
                  <div className="moneyboy-diff-content-wrappers" data-multi-tabs-content-tab>
                    <div>
                        ...
                        <div data-multi-dem-cards-layout>
                          <div className="creator-content-filter-grid-container">
                            ...
                            <div className="creator-content-cards-wrapper multi-dem-cards-wrapper-layout"
                              data-multi-child-grid-layout-wishlist data-2-cols>
                                          ...
                                          <li>
                                            <a href="#" className="post-comment-btn">
                                              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                ...
                                                <path d="M7 8H17" stroke="white" strokeWidth="1.5"
                                                  strokeLinecap="round" strokeLinejoin="round"></path>
                                                <path d="M7 13H13" stroke="white" strokeWidth="1.5"
                                                  strokeLinecap="round" strokeLinejoin="round"></path>
                                              </svg>
                                              <span>15</span>
                                            </a>
